  ...
  return (
    <div className={classes.about} ref={ref}>
      ...
      <p>
        ...
        my academic knowledge in a practical and efficient way to develop
        purposeful software. Eager to learn new industry best practices to
        improve software development.
      </p>
      <h3 className={classes.facts}>Fun facts</h3>
      <li>
        I have a 2 year old cat called Stella. I adopted her when she was 5
        weeks old at the shelter.
      </li>
      <li>
        When I was younger I used to draw and paint. I still like to do it when
        I have some spare time.
      </li>
      <li>
        Sports have always been part of my life. Every since I was young I used
        to swim and play soccer. Nowadays I like hiking, boxing and muay-thai.
      </li>
